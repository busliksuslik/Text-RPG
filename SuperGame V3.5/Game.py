...
init()
print("");print(Fore.CYAN + "Super Game");print("")
time.sleep(0.5)
done = 0
hp_max = 1
hp_current = 1
...
while True: # Цикл выбора имени персонажа
    ...
    if len(name) > 12:
        print("");print(Fore.RED + "Имя не может быть длиннее 12 символов!");print(Fore.CYAN + "")
        continue
    else:
        break
while True: # Цикл выбора класса персонажа
    ...
    if hero_class == "Инфотехнолог":
        ...
        print("");print(Fore.RED + "Выберите корректный класс!");print(Fore.CYAN + "")
        continue
print("");print("...")
time.sleep(x + 1.25)
...
while True:
    ...
    if quest_smoked == False:
        answer = input("Что делать(Уйти/Драться/Покурить): ")
        if answer == "Драться":
            hero = 1
            ...
            while True:
                ...
                if answer == "Покурить":
                    ...
                    while True:
                        if done == 1:
                            break
                        answer = input('Дать сигарету?(Да/Нет): ')
                        if answer == "Да":
        ...
        answer = input("Что делать(Уйти/Драться): ")
        if answer == "Драться":
            hero = 1
            money += fight.fight(level,hp_max,hp_current,dmg,defen, hero)
            time.sleep(x + 2.15)
